...
<head>
    ...
    <!-- Replace with the POST SLUG of the selected post.-->
    ...
    <body style="display: flex; flex-direction: column; min-height: 100vh;">
        ...
        <main class="container my-2">
            ...
            <?php if(isset($_SESSION['ArchivedPosts'])): ?>
                <?php foreach($_SESSION['ArchivedPosts'] as $row) :?>
                                    ...
                                    <?php if(isset($_SESSION['user']['UserRole'])) : ?>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <li><a class="dropdown-item" href="/Final-Project-Waltenberg/backend/archives/<?= base64_encode($row->PostID)?>/<?= urlencode(slugify($row->Title))?>/">Un-Archive</a></li>
                                            </ul>
                                        </div>
                                    <?php endif; ?>
                                </div>
