            ...
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <?php if(isset($_SESSION['user'])) : ?>
                        <a class="nav-link" href="/Final-Project-Waltenberg/public/posts/submit">Create New Post</a>
                    <?php endif; ?>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="margin-right: 20px;">
                        <!-- Replace with the current admin/user, then default to the Guest -->    
                    ...
                    <ul class="dropdown-menu m-2" aria-labelledby="navbarDropdownMenuLink" >
                        ...
                        <?php if(isset($_SESSION['user'])) : ?>
                            ...
                            <?php if($_SESSION['user']['UserRole'] === 'Admin') : ?>
                                <li><a class="dropdown-item" href="/Final-Project-Waltenberg/backend/posts/">Admin Actions</a></li>
                            <?php endif; ?>
